...
- (void)baseInit {
  _notSelectedImage = [UIImage imageNamed:@"star.png"];
  _halfSelectedImage = [UIImage imageNamed:@"starhalf.png"];
  _fullSelectedImage = [UIImage imageNamed:@"starhighlighted.png"];
  _rating = 0;
  _editable = NO;
